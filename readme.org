...
** Library Compilations
  ...
  [UPDATE 2020-03-06] Load obvius via quicklisp and the library should be autimatically
  compiled. Assumed that you have cmake and dependencies installed. (tested on LINUX)
